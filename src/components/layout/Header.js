        ...
        <div className="user">
            ...
            {user ? (
                       <div>
                        ...
                        <Link to = '/course/create/list/:id' id='create-course' onClick={myCourseHandle} >My Course</Link>
                            ...
                            <div className="dropdown-menu" aria-labelledby="dropDownMenuButton">
                                ...
                                <Link className="dropdown-item" id="head-item" to="/enroll/user/:id"  onClick={myEnrollCourseHandle} >MyEnrollCourses</Link>
                                <Link className="dropdown-item" id="head-item" to="/user/:id" >Profile</Link>
