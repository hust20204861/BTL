    ...
    <Fragment>
       <header>
        ...
        <div className="user">
            ...
            <Link to = '/mycourse' id='create-course'onClick={myCourseHandle} >My Course</Link>
                       ...
                       <div>
                        ...
                        <div className="dropdown">
                            ...
                            <div className="dropdown-menu" aria-labelledby="dropDownMenuButton">
                                ...
                                <Link className="dropdown-item" id="head-item" to="/me"  onClick={myEnrollCourseHandle} >MyEnrollCourses</Link>
